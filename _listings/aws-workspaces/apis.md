...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/modifications/master/_listings/aws-workspaces/apis.md
...
- name: AWS WorkSpaces Service API - Modify Workspace Properties
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/modifications/master/_listings/aws-workspaces/actionmodifyworkspaceproperties-get-openapi.md
- name: AWS WorkSpaces Service API - Modify Workspace Properties
  x-api-slug: actionmodifyworkspaceproperties-get
  description: Modifies the WorkSpace properties, including the running mode and AutoStop
    time.
